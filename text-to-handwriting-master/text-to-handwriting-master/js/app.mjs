 ...
 *
 * If you have any questions related to code, you can drop them in my Twitter DM @sadhin24xp
...
const contributors = [
  {
    html_url: 'https://github.com/Sadhin24',
    login: 'Sadhin24',
    avatar_url: 'https://github.com/Sadhin24.png',
  },
];

document.querySelector('#project-contributors').innerHTML = contributors
  .map(
    (contributor) => /* html */ `
